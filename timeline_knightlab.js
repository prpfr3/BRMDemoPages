...
(() => {
        ...
        t.exports = (function () {
          ...
          var Z = function () {
            ...
            G = function (t, e) {
              ...
              e.currentScript &&
                e.currentScript.hasAttribute(a) &&
                (i = e.currentScript.getAttribute(a));
              var s = 'dompurify' + (i ? '#' + i : '');
              try {
          ...
          return (function t() {
            ...
            if ('function' == typeof r) {
              ...
              at.content &&
                at.content.ownerDocument &&
                (s = at.content.ownerDocument);
            }
            var st = G(X, a),
            ...
            var _t = z,
              ...
              Vt = function (t) {
                (Gt && Gt === t) ||
                  ((t && 'object' === (void 0 === t ? 'undefined' : U(t))) ||
                    (t = {}),
                  (t = T(t)),
                  (wt = 'ALLOWED_TAGS' in t ? x({}, t.ALLOWED_TAGS) : kt),
                  (xt = 'ALLOWED_ATTR' in t ? x({}, t.ALLOWED_ATTR) : Tt),
                  (Wt =
                    'ADD_URI_SAFE_ATTR' in t
                      ? x(T(Zt), t.ADD_URI_SAFE_ATTR)
                      : Zt),
                  (Bt =
                    'ADD_DATA_URI_TAGS' in t
                      ? x(T(Ut), t.ADD_DATA_URI_TAGS)
                      : Ut),
                  (Mt = 'FORBID_TAGS' in t ? x({}, t.FORBID_TAGS) : {}),
                  (Et = 'FORBID_ATTR' in t ? x({}, t.FORBID_ATTR) : {}),
                  (Ft = 'USE_PROFILES' in t && t.USE_PROFILES),
                  (Lt = !1 !== t.ALLOW_ARIA_ATTR),
                  (Dt = !1 !== t.ALLOW_DATA_ATTR),
                  ...
                  Ft &&
                    ((wt = x({}, [].concat(W(I)))),
                    (xt = []),
                    !0 === Ft.html && (x(wt, E), x(xt, C)),
                    !0 === Ft.svg && (x(wt, L), x(xt, j), x(xt, R)),
                    !0 === Ft.svgFilters && (x(wt, D), x(xt, j), x(xt, R)),
                    !0 === Ft.mathMl && (x(wt, A), x(xt, O), x(xt, R))),
                  t.ADD_TAGS && (wt === kt && (wt = T(wt)), x(wt, t.ADD_TAGS)),
                  t.ADD_ATTR && (xt === Tt && (xt = T(xt)), x(xt, t.ADD_ATTR)),
                  t.ADD_URI_SAFE_ATTR && x(Wt, t.ADD_URI_SAFE_ATTR),
                  Ht && (wt['#text'] = !0),
                  Nt && x(wt, ['html', 'head', 'body']),
                  wt.table && (x(wt, ['tbody']), delete Mt.tbody),
                  n && n(t),
                  (Gt = t));
              },
            ...
            var te = 'http://www.w3.org/1998/Math/MathML',
              ...
              ne = function (t, e) {
                try {
                  _(i.removed, { attribute: e.getAttributeNode(t), from: e });
                } catch (t) {
                  _(i.removed, { attribute: null, from: e });
                }
              ...
              he = function (t) {
                return 'object' === (void 0 === l ? 'undefined' : U(l))
                  ? t instanceof l
                  : t &&
                      'object' === (void 0 === t ? 'undefined' : U(t)) &&
              ...
              ce = function (t) {
                var e = void 0;
                if ((de('beforeSanitizeElements', t, null), le(t)))
                  return se(t), !0;
                if (f(t.nodeName, /[\u0080-\uFFFF]/)) return se(t), !0;
                var a = p(t.nodeName);
                if (
                  (de('uponSanitizeElement', t, {
                    tagName: a,
                    allowedTags: wt,
                  }),
                  ...
                  if (Ht && !$t[a]) {
                    ...
                    if (n && s)
                      for (var o = n.length - 1; o >= 0; --o)
                        s.insertBefore(Q(n[o], !0), tt(t));
                  }
                  return se(t), !0;
                }
                return t instanceof h && !ae(t)
                  ? (se(t), !0)
                  : ('noscript' !== a && 'noembed' !== a) ||
                  ...
                  ? (At &&
                      ...
                      (e = g(e, pt, ' ')),
                      t.textContent !== e &&
                        (_(i.removed, { element: t.cloneNode() }),
                        (t.textContent = e))),
                    de('afterSanitizeElements', t, null),
                    !1)
                  : (se(t), !0);
              },
              ue = function (t, e, i) {
                if (Pt && ('id' === e || 'name' === e) && (i in s || i in Yt))
                  return !1;
                if (Dt && b(ft, e));
                else if (Lt && b(gt, e));
                else {
                ...
                if (o) {
                  ...
                  for (n = o.length; n--; ) {
                    ...
                    if (
                      ...
                      de('uponSanitizeAttribute', t, r),
                      (a = r.attrValue),
                      !r.forceKeepAttr && (ne(h, t), r.keepAttr))
                    )
                      if (b(/\/>/i, a)) ne(h, t);
                      else {
              ...
              _e = function t(e) {
                var i = void 0,
                  a = re(e);
                for (
                  de('beforeSanitizeShadowDOM', e, null);
                  (i = a.nextNode());

                )
                  de('uponSanitizeShadowNode', i, null),
                    ce(i) || (i.content instanceof o && t(i.content), me(i));
                de('afterSanitizeShadowDOM', e, null);
              };
            return (
              (i.sanitize = function (t, s) {
                var n = void 0,
                  r = void 0,
                  h = void 0,
                  d = void 0,
                  c = void 0;
                if (
                  (t || (t = '\x3c!--\x3e'), 'string' != typeof t && !he(t))
                ) {
                ...
                if (
                  (It || Vt(s),
                  (i.removed = []),
                  'string' == typeof t && (qt = !1),
                  qt)
                );
                else if (t instanceof l)
                  (1 ===
                    (r = (n = oe('\x3c!----\x3e')).ownerDocument.importNode(
                      t,
                      !0
                    )).nodeType &&
                    'BODY' === r.nodeName) ||
                  ...
                  if (!jt && !At && !Nt && -1 === t.indexOf('<'))
                    return st && zt ? st.createHTML(t) : t;
                  if (!(n = oe(t))) return jt ? null : nt;
                }
                n && Ct && se(n.firstChild);
                for (var u = re(qt ? t : n); (h = u.nextNode()); )
                  (3 === h.nodeType && h === d) ||
                    ce(h) ||
                    (h.content instanceof o && _e(h.content), me(h), (d = h));
                if (((d = null), qt)) return t;
                if (jt) {
                  if (Ot)
                    for (c = dt.call(n.ownerDocument); n.firstChild; )
                ...
                return (
                  At && ((m = g(m, _t, ' ')), (m = g(m, pt, ' '))),
                  st && zt ? st.createHTML(m) : m
                );
              }),
                      ...
                      value: function (t) {
                        if (t.nodeType === Node.ELEMENT_NODE) {
                          ...
                          e !== this._rootElement &&
                            ...
                            (a.call(e, s) || e.hasAttribute('tabindex')) &&
                              this._manageNode(e);
                        }
                      },
                    },
                        ...
                        if (e) {
                          ...
                          if (
                            ...
                            for (var a = t.parentNode; a; )
                              11 === a.nodeType && d(a), (a = a.parentNode);
                        } else {
                          if (!this._inertRoots.has(t)) return;
          ...
          function h(t, e, i) {
            if (t.nodeType == Node.ELEMENT_NODE) {
              ...
              if ('content' == a.localName) {
                for (
                  var n = a,
                    o = n.getDistributedNodes ? n.getDistributedNodes() : [],
                    r = 0;
                  r < o.length;
                  r++
                )
  ...
  (() => {
    ...
    function L(t) {
      for (
        var e = Array.prototype.slice.call(arguments, 1), i = 0, a = e.length;
        i < a;
        i++
      )
        E(t, e[i] || {});
    ...
    function R(t) {
      t = (t = j(t)).toLowerCase();
      for (
        var e = 'Ã£Ã Ã¡Ã¤Ã¢áº½Ã¨Ã©Ã«ÃªÃ¬Ã­Ã¯Ã®ÃµÃ²Ã³Ã¶Ã´Ã¹ÃºÃ¼Ã»Ã±Ã§Â·/_,:;',
          i = 0,
          a = e.length;
        i < a;
        i++
    ...
    function z(t, e) {
      var i = function (t) {
        for (var e = '', i = 0; i < t; i++)
          e += 'abcdefghijklmnopqurstuvwxyz'.substr(
    ...
    function $(t, e, i) {
      var a = function (t, e, i) {
        return (
          i || (i = ''),
          e && e.length > 30 && (e = e.substring(0, 30) + 'â€¦'),
          i +
    ...
    const U = (t) => {
      ...
      W = (t) =>
        null !== t.w && '' !== t.w
          ...
          : 0;
    let Z =
      ((Y = (G = '123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ')
        .length),
      {
        encode: function (t) {
    ...
    it.extend = function (t) {
      ...
      return (
        ...
        t.includes &&
          (L.apply(null, [a].concat(t.includes)), delete t.includes),
    ...
    class at {
      on(t, e, i) {
        ...
        return (
          (a[t] = a[t] || []),
          a[t].push({ action: e, context: i || this }),
          this
        );
      }
      ...
      fire(t, e) {
        if (!this.hasEventListeners(t)) return this;
        for (
          var i = E({ type: t, target: this }, e),
            a = this._tl_events[t].slice(),
            s = 0,
            n = a.length;
          s < n;
          s++
          ...
          a[s].action
            ? a[s].action.call(a[s].context || this, i)
            : S(`no action defined for ${t} listener`);
        return this;
      }
    }
    function st(t, e) {
    ...
    const nt = (function () {
      ...
      function k(t, e) {
        var i,
          a = {};
        return (
          (i = t.match(c)) && (a.rotate = N(i[1], e ? e.rotate : null)),
          (i = t.match(u)) && (a.scale = N(i[1], e ? e.scale : null)),
          (i = t.match(m)) &&
            ((a.skewx = N(i[1], e ? e.skewx : null)),
            (a.skewy = N(i[3], e ? e.skewy : null))),
          (i = t.match(_)) &&
            ((a.translatex = N(i[1], e ? e.translatex : null)),
            (a.translatey = N(i[3], e ? e.translatey : null))),
          a
        );
      }
      function x(t) {
        ...
        return (
          s
            ? ((e = s[1]),
              ...
              (a = s[3]),
              '#' +
                ((1 << 24) | (e << 16) | (i << 8) | a).toString(16).slice(1))
            : t
            ...
            if (r > h || m)
              return (
                ...
                (function (t) {
                  ...
                  i >= 0 &&
                    ((e = b.slice(i + 1)), (b.length = i), (b = b.concat(e)));
                })(t),
                i && i.apply(d)
              );
      ...
      function A(t, e, i, a, s, n, o) {
        if ('transform' == s) {
          for (var l in ((o = {}), i[n][s]))
            o[l] =
              l in a[n][s]
                ? Math.round(((a[n][s][l] - i[n][s][l]) * t + i[n][s][l]) * r) /
                  r
                : i[n][s][l];
          return o;
        }
        return 'string' == typeof i[n][s]
          ...
          : ((o = Math.round(((a[n][s] - i[n][s]) * t + i[n][s]) * r) / r),
            s in p || (o += e[n][s] || 'px'),
            o);
      }
      function N(t, e, i, a, s) {
        return (i = h.exec(t))
          ? (s = parseFloat(i[2])) && e + ('+' == i[1] ? 1 : -1) * s
          : parseFloat(t);
      }
      function I(t, e) {
        var i,
        ...
        for (
          ...
          if (((u[i] = {}), (m[i] = {}), (_[i] = {}), c)) {
            var y = v(n[i], 'left'),
              b = v(n[i], 'top'),
              w = [
                N(E(a) ? a(n[i]) : a || 0, parseFloat(y)),
                N(E(s) ? s(n[i]) : s || 0, parseFloat(b)),
              ];
            (p[i] = E(c) ? c(n[i], w) : c),
              p[i].push(w),
          ...
          for (var L in e) {
            ...
            var I,
              C = v(n[i], L),
              j = E(e[L]) ? e[L](n[i]) : e[L];
            'string' != typeof j || !l.test(j) || l.test(C)
              ? ((u[i][L] =
                  'transform' == L
                    ? k(C)
                    : 'string' == typeof j && l.test(j)
                    ? T(C).slice(1)
                    : parseFloat(C)),
                (m[i][L] =
                  'transform' == L
                    ? k(j, u[i][L])
                    : 'string' == typeof j && '#' == j.charAt(0)
                    ? T(j).slice(1)
                    : N(j, parseFloat(C))),
                'string' == typeof j && (I = j.match(d)) && (_[i][L] = I[1]))
              : delete e[L];
          }
        }
        return D.apply(n, [
        ...
        removeListener: function (t, e, i) {
          ...
          n &&
            (f && 'dblclick' === e && this.removeDoubleTapListener
              ...
              ? 'mousewheel' === e
                ? (t.removeEventListener('DOMMouseScroll', n, !1),
          ...
          (E.init = function (e, a) {
            ...
            if ('string' == typeof e)
              if ('<' == (e = e.trim())[0] && m.test(e))
                (s = E.fragment(e, RegExp.$1, a)), (e = null);
              else {
              ...
              if (S(e))
                ...
                (s = E.fragment(e.trim(), RegExp.$1, a)), (e = null);
              else {
                if (a !== t) return i(a).find(e);
                s = E.qsa(h, e);
              }
          ...
          (i.fn = {
            ...
            closest: function (t, e) {
              var a = this[0],
                s = !1;
              for (
                'object' == typeof t && (s = i(t));
                a && !(s ? s.indexOf(a) >= 0 : E.matches(a, t));

              )
                a = a !== e && !C(a) && a.parentNode;
              return i(a);
            },
            parents: function (t) {
              for (var e = [], a = this; a.length > 0; )
                a = i.map(a, function (t) {
                  if ((t = t.parentNode) && !C(t) && e.indexOf(t) < 0)
                    return e.push(t), t;
                });
              return $(e, t);
            },
            ...
            attr: function (i, a) {
              ...
              return 'string' == typeof i && a === t
                ...
                : this.each(function (t) {
                    if (1 === this.nodeType)
                      if (j(i)) for (e in i) U(this, e, i[e]);
            ...
            offsetParent: function () {
              return this.map(function () {
                for (
                  ...
                  t && !f.test(t.nodeName) && 'static' == i(t).css('position');
            ...
            (i.fn[t] = function () {
              var t,
                ...
                n = i.map(arguments, function (e) {
                  return 'object' == (t = A(e)) || 'array' == t || null == e
                    ? e
                    : E.fragment(e);
                }),
                o = this.length > 1;
              ...
              (i.fn[a ? t + 'To' : 'insert' + (e ? 'Before' : 'After')] =
                function (e) {
          ...
          a.split(/\s/).forEach(function (a) {
            ...
            (o.proxy = function (t) {
              ...
              'addEventListener' in i &&
                i.addEventListener(p(o.e), o.proxy, _(o, h));
          });
        }
        function g(t, e, i, a, s) {
          ...
          (e || '').split(/\s/).forEach(function (e) {
            u(t, e, i, a).forEach(function (e) {
              delete o[n][e.i],
                'removeEventListener' in t &&
                  t.removeEventListener(p(e.e), e.proxy, _(e, s));
            });
          });
        }
              ...
              this.each(function (o, r) {
                ((a = x(n(e) ? t.Event(e) : e))._args = i),
                  ...
                  t.each(u(r, e.type || e), function (t, e) {
                    if (((s = e.proxy(a)), a.isImmediatePropagationStopped()))
                      return !1;
                  });
              }),
              s
      ...
      (function (t) {
        ...
        (t.active = 0),
          ...
          (t.ajax = function (a) {
              ...
              (function (e) {
                e.processData &&
                  ...
                  !e.data ||
                    ...
                    ((e.url = g(e.url, e.data)), (e.data = void 0));
              })(s),
            ...
            for (i in (T.open(s.type, s.url, E, s.username, s.password), w))
              M.apply(T, w[i]);
            return (
              s.timeout > 0 &&
    ...
    const ct = dt.getJSON,
      ...
      yt = it.extend({
        ...
        getDisplayDate: function (t, e) {
          ...
          t || (t = At.fallback),
            t.constructor != At &&
              (S('First argument to getDisplayDate must be type Language'),
              (t = At.fallback));
        ...
        findBestFormat: function (t) {
          for (var e = pt, i = 0; i < e.length; i++)
            if (this.data[e[i]])
              return t ? t in vt || (t = 'short') : (t = 'base'), vt[t][e[i]];
          return '';
        },
    ...
    class At {
        ...
        if (t && 'string' == typeof t && 'en' != t) {
          ...
          if (!(i in Ct)) {
            ...
            mt(a)
              ...
              .catch((t) => {
                console.log(
                  `Error loading language [${a}] ${t.statusText} [${t.status}]`
                );
              });
          }
          E(this, Ct[i]);
      ...
      mergeData(t) {
        for (k in Ct.en)
          t[k] &&
            ('object' == typeof this[k] ? E(t[k], this[k]) : (this[k] = t[k]));
      }
      formatBigYear(t, e) {
        var i = t.year,
        ...
        return (
          S('Language file dateformats missing cosmological. Falling back.'),
          It(i, e)
        );
      }
      _(t, e) {
      ...
      formatDate(t, e) {
        return t.constructor == Date
          ...
          : (S('Unfamiliar date presented for formatting'), t.toString());
      }
      formatJSDate(t, e) {
        var i = this,
          a = function (t, e) {
    ...
    (At.fallback = { messages: {} }),
      (At.DATE_FORMAT_TOKENS =
    ...
    class Rt {
      ...
      _initLayout() {
        (this._el.message_container = v(
          'div',
          'tl-message-container',
          this._el.container
        )),
          (this._el.loading_icon = v(
            'div',
    ...
    function Pt(t) {
      ...
      if (s.length > 2) {
        ...
        if (((e.second = parseInt(s[0])), isNaN(e.second)))
    ...
    const Ft = { human: yt, cosmological: Dt };
    var $t = i(856),
      Bt = i.n($t);
    ...
    class Yt {
      ...
      addEvent(t, e) {
        ...
        return void 0 === t.start_date
          ? (S('Missing start date, skipping event'), console.log(t), null)
      ...
      _assignID(t) {
        var e = t.unique_id;
        return (
          j(e) || (e = t.text ? R(t.text.headline) : null),
      ...
      _makeUniqueIdentifiers(t, e) {
        for (var i = [t], a = 0; a < e.length; a++)
          j(e[a].unique_id) &&
            ((e[a].unique_id = R(e[a].unique_id)),
            -1 == i.indexOf(e[a].unique_id)
              ? i.push(e[a].unique_id)
              : (e[a].unique_id = ''));
            ...
            if (
              ...
              let e = (function (t) {
                ...
                if (
                  ...
                  if (a.start_date && !qt(a.start_date))
                    throw new x('invalid_date_err');
                  if (a.end_date && !qt(a.end_date))
                    throw new x('invalid_date_err');
                }
                return a;
              })(t);
      ...
      ie = function (t, e) {
        ...
        for (var i = 0; i < e.length - 1; i++) {
          ...
          ee[t].push(
            new te({
              scale: a[3],
              minor: { name: a[0], factor: a[1] },
              major: { name: s[0], factor: s[1] },
            })
          );
        }
      };
    ...
    class se {
      ...
      _assessGroups(t) {
        for (var e = [], i = !1, a = 0; a < t.length; a++)
          t[a].group &&
            (e.indexOf(t[a].group) < 0 ? e.push(t[a].group) : (i = !0));
      ...
      _computePositionInfo(t, e, i) {
        ...
        for (var a = [], s = !1, n = 0; n < t.length; n++) {
          ...
          t[n].group
            ? a.indexOf(t[n].group) < 0 && a.push(t[n].group)
            : (s = !0);
        }
        if (a.length) {
          s && a.push('');
          ...
          for (var _ = 0; n < l.length; n++) {
            for (
              this._group_labels.push({ label: l[n].label, rows: l[n].n_rows }),
                h = 0;
              h < l[n].positions.length;
              h++
            )
    ...
    class oe {
      ...
      _initLayout() {
        (this._el.container = v('div', 'tl-timeera')),
          ...
          (this._el.content_container = v(
            'div',
            'tl-timeera-content-container',
            this._el.container
          )),
          (this._el.background = v(
            'div',
          ...
          this.headline &&
            '' != this.headline &&
            (this._text.innerHTML = q(this.headline)),
          this.onLoaded();
      }
      _initEvents() {}
      _updateDisplay(t, e, i) {
      ...
      _createTickElements(t, e, i, a) {
        ...
        for (n = 0; n < t.length; n++) {
          ...
          if (!(r.getTime() in s)) {
            ...
            (h.innerHTML = t),
              o.push({ tick: l, tick_text: h, display_date: t, date: r });
          }
        }
        return o;
      }
      ...
      _positionTickArray(t, e, i) {
        if (t[1] && t[0]) {
          ...
          e.getPosition(t[1].date.getMillisecond()) -
            ...
            i && (a = Math.round(i / e.getPixelsPerTick()));
    ...
    class le {
      constructor(t, e, i) {
        (this._el = {
          ...
          (function (t, e) {
            (t.data = L({}, t.data, e)),
              '' === t.data.unique_id && (t.data.unique_id = z(6));
          })(this, t),
          E(this.options, e),
      ...
      constructor(t, e, i) {
        i && this.setLanguage(i),
          ...
          this.options.background ||
            ((this._el.container = v('div', 'tl-media')),
            this.data.unique_id &&
              (this._el.container.id = this.data.unique_id),
            this._initLayout());
      }
            ...
            (d = h[n]),
              u
                ? (r = this.env.gecko
                    ...
                    : this.createNode('link', { href: d, rel: 'stylesheet' }))
        ...
        (this.youtube_loaded = !1),
          ...
          (t = (function (t) {
            ...
            for (var n = 0; n < a.length; n++)
              (i = a[n].split('=')), s.push(i[0]), (s[i[0]] = i[1]);
            return s;
          })(this.data.url)),
          (this.media_id = {}),
          this.data.url.match('v=')
            ...
            ? (this.media_id.id = this.data.url
                ...
                .split(/[?&]/)[0])
            : S('YOUTUBE IN URL BUT NOT A VALID VIDEO'),
          this.data.url.match('start=')
            ? (this.media_id.start = V(this.data.url.split('start=')[1]))
            : this.data.url.match('t=') &&
              (this.media_id.start = V(this.data.url.split('t=')[1])),
          this.data.url.match('end=') &&
            (this.media_id.end = V(this.data.url.split('end=')[1])),
          (this.media_id.hd = Boolean(void 0 !== t.hd)),
          ce('https://www.youtube.com/iframe_api', function () {
            e.createMedia();
          });
      }
      _updateMediaDisplay() {
        (this._el.content_item.style.height =
          W({ w: this.options.width }) + 'px'),
    ...
    class pe extends he {
      ...
      _updateMediaDisplay() {
        if (this._state.loaded) {
          var t = U({ w: this._el.content_item.offsetWidth });
      ...
      makeGoogleMapsEmbedURL(t, e) {
        var i = !1,
          ...
          l = {
            ...
            place: new RegExp(
              s.source + '/place/' + o.source + '/' + n.source + r.source
            ),
            ...
            search: new RegExp(
              s.source + '/search/' + o.source + '/' + n.source + r.source
            ),
          };
        return (function (t) {
          function s(e, s) {
      ...
      createMedia(t) {
        ...
        if (t.query) {
          ...
          for (var a = 0; a < e.text_array.length; a++)
            a + 1 <= e.paragraphs &&
              a + 1 < e.text_array.length &&
              (e.text += '<p>' + e.text_array[a + 1]);
    ...
    class ve extends he {
            ...
            ct(t, function (t) {
              let e = (function (t) {
                ...
                if (t.query && t.query.pages) {
                  ...
                  (e.url = a.imageinfo[0].thumburl),
                    a.entityterms &&
                      a.entityterms.label &&
                      (e.label = a.entityterms.label[0]);
                }
                return e;
              })(t);
              e.url
      ...
      createMedia() {
        ...
        if (
          ...
          mt(
            `https://commons.wikimedia.org/w/api.php?action=wbgetentities&format=json&ids=${e}&format=json&origin=*`
          ).then((i) => {
            if (i.entities && i.entities[e]) {
              ...
              a[s]
                ? (n = a[s])
                : s.length > 2 && a[s.substr(0, 2)]
                ? (n = a[s.substr(0, 2)])
                : a.en && (n = a.en),
                n
                  ? (console.log(`wikibase_id: ${t.media_id} alt ${n.value}`),
                    (t.data.alt = n.value),
                    (t._el.content_item.alt = t.data.alt))
    ...
    class be extends he {
      ...
      _updateMediaDisplay() {
        this._el.content_item.style.height =
          W({ w: this._el.content_item.offsetWidth }) + 'px';
      }
      _stopMedia() {
        try {
          this.player &&
        ...
        (this._el.content_item = this.domCreate(
          ...
          -1 != this.data.url.indexOf('dai.ly/')
            ? (this.media_id = this.data.url.substr(
                this.data.url.indexOf('dai.ly/') + 'dai.ly/'.length
              ))
      ...
      createMedia(t) {
        ...
        (n = t.html.split('</p>&mdash;')[0] + '</p></blockquote>'),
          ...
          (n = n.replace(
            ...
            ? (ce('https://platform.twitter.com/widgets.js', function () {
      ...
      getImageURL(t, e) {
        for (
          var i = this.size_label(e),
            a = this.sizes[this.sizes.length - 2].source,
            s = 0;
          s < this.sizes.length;
          s++
        )
        ...
        (this._el.content_item = this.domCreate(
          ...
          this.data.url.match(/\.html$/)
            ...
            : this.data.url.match(/.(json|js)$/) ||
              S('DOCUMENT CLOUD IN URL BUT INVALID SUFFIX'),
          ce(
            [
    ...
    class je extends he {
      constructor(t, e, i) {
        super(t, e, i),
          (this.iframe = Bt().sanitize(this.data.url, {
            ADD_TAGS: ['iframe'],
    ...
    class He extends he {
      _loadMedia() {
        ...
        (this._el.content_item = this.domCreate(
          ...
          S(`Wistia: media_id: ${this.media_id}`),
          (t =
    ...
    function qe(t, e) {
      var i = [
        ...
        { type: 'spotify', name: 'spotify', match_str: 'spotify', cls: Ce },
        { type: 'iframe', name: 'iFrame', match_str: 'iframe', cls: je },
        { type: 'blockquote', name: 'Quote', match_str: 'blockquote', cls: fe },
        {
          type: 'video',
          name: 'Video',
        ...
        { type: 'imageblank', name: 'Imageblank', match_str: '', cls: de },
      ];
      if (e) {
    ...
    class Fe {
      ...
      _initLayout() {
        if (
          ...
          (this._el.line_left = v(
            'div',
            'tl-timemarker-line-left',
            this._el.timespan
          )),
          (this._el.line_right = v(
            'div',
        ...
        (this._el.text = v('div', 'tl-timemarker-text', this._el.content)),
          ...
          this.data.text.headline && '' != this.data.text.headline
            ? (this._text.innerHTML = q(this.data.text.headline))
            : this.data.text.text && '' != this.data.text.text
            ? (this._text.innerHTML = q(this.data.text.text))
            : this.data.media &&
    ...
    class Be {
      ...
      _getTimeScale() {
        ...
        return (
          0 == t && (S('marker_height_min option must not be zero.'), (t = 30)),
      ...
      zoomIn() {
        var t = (function (t, e, i) {
          for (var a = 0; a < t.length; a++) if (e < t[a]) return t[a];
          return e;
      ...
      zoomOut() {
        var t = (function (t, e, i) {
          for (var a = t.length - 1; a >= 0; a--) if (e > t[a]) return t[a];
          return e;
        })(this.options.zoom_sequence, this.options.scale_factor);
        this.setZoomFactor(t);
      }
      ...
      _assignRowsToMarkers() {
        ...
        for (var i = 0; i < this._markers.length; i++) {
          ...
          var a = this.timescale.getPositionInfo(i).row,
            s =
              Math.floor(a * (e + this.options.marker_padding)) +
              this.options.marker_padding,
      ...
      _findMarkerIndex(t) {
        ...
        return (
          ('string' == typeof t || t instanceof String) &&
            (e = H(t, this._markers, 'unique_id', e)),
          e
        );
      }
      _createEras(t) {
      ...
      _positionEras(t) {
        for (var e = 0, i = 0; i < this._eras.length; i++) {
          ...
          (a.start = this.timescale.getPosition(
            this._eras[i].start_date.getTime()
          )),
            (a.end = this.timescale.getPosition(
        ...
        this._resetMarkersActive(),
          ...
          t >= 0 && t < this._markers.length
            ? (this.current_id = this.current_focused_id =
                this._markers[t].data.unique_id)
            : (this.current_id = this.current_focused_id = ''),
          ...
          e
            ? ((this._el.slider.className = 'tl-timenav-slider'),
              (this._el.slider.style.left =
                -this._markers[t].getLeft() + this.options.width / 2 + 'px'))
            : i
    ...
    class Ue {
          ...
          h && this.options.width <= this.options.skinny_size
            ...
            : 'landscape' == i ||
              (this.options.width <= this.options.skinny_size &&
                ((s = 50), (n = 50), (a = this.options.width - s - n))),
      ...
      _initLayout() {
        ...
        this.data.media &&
          ...
          this.has.media &&
            ((this.data.media.mediatype = qe(this.data.media)),
          ...
          (this.has.text || this.has.headline) &&
            ((this._text = new le(this.data.text, {
    ...
    class Ze {
      constructor(t, e, i, a) {
        a && this.setLanguage(a),
          ...
          'object' == typeof t
            ? ((this._el.container = t), (this.options.id = z(6, 'tl')))
            : ((this.options.id = t), (this._el.container = g(t))),
      ...
      _createSlides(t) {
        for (var e = 0; e < t.length; e++)
          '' == t[e].unique_id && (t[e].unique_id = z(6, 'tl-slide')),
      ...
      changeBackground(t) {
        ...
        t.color_value && '' != t.color_value
          ? (e = M(t.color_value)) ||
            (S('Invalid color value ' + t.color_value),
      ...
      _initLayout() {
        this._el.container.classList.add('tl-storyslider'),
          (this._nav.previous = new We(
            { title: 'Previous', description: 'description' },
            { direction: 'previous' },
            this._el.container
          )),
          (this._nav.next = new We(
            { title: 'Next', description: 'description' },
            { direction: 'next' },
            this._el.container
          )),
          (this._el.slider_container_mask = v(
            'div',
          ...
          (this._el.slider_container = v(
            'div',
            'tl-slider-container tlanimate',
            this._el.slider_container_mask
          )),
          (this._el.slider_item_container = v(
            'div',
        ...
        if (this._loaded) {
          ...
          (e =
            ...
            this.hasEventListeners(e) &&
              ('contextmenu' === e && ht.preventDefault(t),
              this.fire(e, {
                latlng: 'something',
    ...
    class Ge {
      ...
      changeVisibleTicks(t) {
        ...
        (this.data.visible_ticks_dates = { start: i, end: a }),
      ...
      _initLayout() {
        (this._el.button_zoomin = y('tl-menubar-button', this._el.container)),
          (this._el.button_zoomout = y(
            'tl-menubar-button',
            this._el.container
          )),
          (this._el.button_forwardtoend = y(
            'tl-menubar-button',
            this._el.container
          )),
          (this._el.button_backtostart = y(
            'tl-menubar-button',
            this._el.container
          )),
          h && this._el.container.setAttribute('ontouchstart', ' '),
    ...
    class Ve {
      constructor(t, e, i) {
        ...
        E(this.options, i),
          ...
          this.options.debug && ((n = console.log), D.push(n)),
      ...
      _initData(t) {
        'string' == typeof t
                ...
                ut({
                  ...
                  error: function (t, e, a) {
                    (s = new Yt()),
                      (a =
                        'parsererror' == e
                          ? new x('invalid_url_err')
                          : new x('unknown_read_err', e)),
                      s.logError(a),
                      i(s);
                  },
                });
          ...
          : Yt == t.constructor
          ? this.setConfig(t)
          : this.setConfig(new Yt(t));
      }
      _translateError(t) {
        return (
          t.hasOwnProperty('stack') && S(t.stack),
          t.message_key
      ...
      showMessage(t) {
        this.message
          ...
          : (S('No message display available.'), S(t));
      }
      determineScriptPath() {
        let t = null;
        if (Ye) t = Ye;
      ...
      setConfig(t) {
        if (
          ...
          for (
            var e = [], i = 0, a = this.config.getErrors();
            i < a.length;
            i++
          )
      ...
      _updateDisplay(t, e, i) {
        ...
        i && (n = i),
          ...
          'portrait' == this.options.layout
            ? (o += ' tl-layout-portrait')
            : (o += ' tl-layout-landscape'),
          (this.options.storyslider_height =
      ...
      _validateOptions() {
        for (
          ...
          'number' == typeof a
            ? (s = a == parseInt(a))
            : 'string' == typeof a && (s = a.match(/^\s*(\-?\d+)?\s*$/)),
            s ||
      ...
      _onLoaded() {
        if (
          ...
          (null != (t = this.options.start_at_end) &&
            (1 == t || 'true' == String(t).toLowerCase() || 1 == Number(t))) ||
      ...
      updateDisplay() {
        this.ready
          ? this._updateDisplay()
          : S('updateDisplay called but timeline is not in ready state');
      }
      focusContainer() {
        this._el.container.focus();
      }
      _initGoogleAnalytics(t) {
        ce(`https://www.googletagmanager.com/gtag/js?id=${t}`),
      ...
      _initAnalytics() {
        let t =
          this.options.ga_measurement_id || this.options.ga_property_id || null;
        if (t) {
